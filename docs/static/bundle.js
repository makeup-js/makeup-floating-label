...
$_mod.def("/makeup-floating-label$0.0.3/index", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/makeup-floating-label$0.0.3/docs/index", function(require, exports, module, __filename, __dirname) { document.addEventListener('DOMContentLoaded', function() {
    var FloatingLabel = require('/makeup-floating-label$0.0.3/index'/*'../index.js'*/);
...
$_mod.run("/makeup-floating-label$0.0.3/docs/index");